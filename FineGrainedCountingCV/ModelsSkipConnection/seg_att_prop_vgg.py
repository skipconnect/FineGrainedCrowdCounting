...
from ModelsSkipConnection.networks import HOUR_GLASS_PROP, CSRNet_TWO
...
class SegAttPropVGG():
    ...
    def forward(self, no_grad=True):
        ...
        self.smap = self.seg_refiner(self.img,self.init_predictor.smap_fea, _dmap)
        ...
        self.dmap = self.cnt_refiner(self.img,self.init_predictor.dmap_fea, _smap)
